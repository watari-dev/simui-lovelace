...
/** Interpolate warm→cool by colour temperature (Kelvin). */
...
/**
 * The CSS colour to drive `--slider-tint`. Returns a literal rgb() for coloured/temp
 * lights, or the `var(--warm)` token (which the user's HA theme can override) otherwise.
 */
